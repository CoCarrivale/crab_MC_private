...
events_per_job = 1000
#events_per_job = 50
PROD='OSWWemu_EWK_dim6_topU3l_2016_noHIPM'
...
config.JobType.scriptExe = 'runners/2016_noHIPM_SMP/run_chain_test.sh'
config.JobType.psetName = 'do_nothing_cfg.py'
config.JobType.pluginName = 'PrivateMC'
config.JobType.outputFiles = ['SMP-RunIISummer20UL16NanoAODv9-00391.root']
config.JobType.inputFiles = [
    'CMSSW_10_6_26.tar.gz', # Patched version for nanoAOD with reweighting weights
    'modifyCfg.py',
    'copy_gridpack.py',
    'get_disk_files.py',
    'runners/2016_noHIPM_SMP/run_chain_test.sh',
    'runners/2016_noHIPM_SMP/chain_step_0_test.sh',
    'runners/2016_noHIPM_SMP/chain_step_1_test.sh',
    'runners/2016_noHIPM_SMP/chain_step_2_test.sh',
    'runners/2016_noHIPM_SMP/chain_step_3_test.sh',
    'runners/2016_noHIPM_SMP/chain_step_4_test.sh',
    'runners/2016_noHIPM_SMP/chain_step_5_test.sh',
    '2016_noHIPM_SMP/wmLHE_step.py',
    '2016_noHIPM_SMP/SIM_step.py',
    '2016_noHIPM_SMP/DIGIpremix_step.py',
    '2016_noHIPM_SMP/HLT_step.py',
    '2016_noHIPM_SMP/RECO_step.py',
    '2016_noHIPM_SMP/miniAODv2_step.py',
    '2016_noHIPM_SMP/NANOv9_step.py'
    ]
