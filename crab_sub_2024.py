...
config.JobType.inputFiles = [
    'CMSSW_15_0_2.tar.gz', # Patched version for nanoAOD with reweighting weights
    'modifyCfg.py',
    'copy_gridpack.py',
    'get_disk_files.py',
    'runners/2024_nAODv15/run_chain_Run3.sh',
    'runners/2024_nAODv15/chain_step_0_LHEGS.sh',
    'runners/2024_nAODv15/chain_step_1_DRPreMix.sh',
#    'runners/2023LHEGS_SMP/chain_step_2_test.sh',
#    'runners/2023LHEGS_SMP/chain_step_3_test.sh',
    'runners/2024_nAODv15/chain_step_4_MiniAOD.sh',
    'runners/2024_nAODv15/chain_step_5_NanoAOD.sh',
    'Run3/Summer24_nAODv15/cfg_RunIII2024Summer24DRPremix_0.py',
    'Run3/Summer24_nAODv15/cfg_RunIII2024Summer24DRPremix.py',
