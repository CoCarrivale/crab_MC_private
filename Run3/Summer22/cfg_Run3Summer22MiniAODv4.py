...
# with command line options: --python_filename PPD-Run3Summer22MiniAODv4-00002_1_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:PPD-Run3Summer22MiniAODv4-00002.root --conditions 130X_mcRun3_2022_realistic_v5 --step PAT --nThreads 2 --geometry DB:Extended --filein file:PPD-Run3Summer22DRPremix-00019.root --era Run3,run3_miniAOD_12X --no_exec --mc -n 10000
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:PPD-Run3Summer22DRPremix-00019.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PPD-Run3Summer22MiniAODv4-00002.root'),
