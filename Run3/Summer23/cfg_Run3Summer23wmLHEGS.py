...
# with command line options: Configuration/GenProduction/python/HIG-Run3Summer23wmLHEGS-00930-fragment.py --python_filename HIG-Run3Summer23wmLHEGS-00930_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:HIG-Run3Summer23wmLHEGS-00930.root --conditions 130X_mcRun3_2023_realistic_v15 --beamspot Realistic25ns13p6TeVEarly2023Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(18) --step LHE,GEN,SIM --geometry DB:Extended --era Run3_2023 --no_exec --mc -n 672
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-Run3Summer23wmLHEGS-00930-fragment.py nevts:672'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-Run3Summer23wmLHEGS-00930.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-Run3Summer23wmLHEGS-00930_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/ZA2JToZA2L2J_EWK_MLL50_Mjj120_5f_LO_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
    generateConcurrently = cms.untracked.bool(False),
    nEvents = cms.untracked.uint32(672),
