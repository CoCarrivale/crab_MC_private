...
CMSSW_RELEASE=CMSSW_8_0_36_UL_patch1
...
#python ${RUN_DIR}/modifyCfg.py ${RUN_DIR}/SMP-RunIISummer20UL18HLT-00035_1_cfg.py ${RUN_DIR}/step_2_cfg.py --randomSeeds=${SEED}
mv ${RUN_DIR}/HLTAPV_step.py ${RUN_DIR}/step_2_cfg.py
