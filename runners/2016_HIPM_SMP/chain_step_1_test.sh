...
# SIM STEP 
python ${RUN_DIR}/modifyCfg.py ${RUN_DIR}/SIMAPV_step.py ${RUN_DIR}/step_1_cfg.py --randomSeeds=${SEED}
...
python ${RUN_DIR}/modifyCfg.py ${RUN_DIR}/DIGIpremixAPV_step.py ${RUN_DIR}/step_1_bis_cfg.py --randomSeeds=${SEED} --strategy 1
