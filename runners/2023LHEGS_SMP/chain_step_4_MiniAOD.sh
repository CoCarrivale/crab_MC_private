...
python3 ${RUN_DIR}/modifyCfg.py ${RUN_DIR}/cfg_Run3Summer23MiniAODv4.py ${RUN_DIR}/out_miniAODv2_step.py --randomSeeds=${SEED}

cmsRun -e -j FrameworkJobReport.xml ${RUN_DIR}/out_miniAODv2_step.py
