...
#DigiRAW STEP FIRST!
python3 ${RUN_DIR}/modifyCfg.py ${RUN_DIR}/cfg_RunIII2024Summer24_0.py ${RUN_DIR}/out_digiRAW_step.py --randomSeeds=${SEED} --strategy 1
...
python3 ${RUN_DIR}/modifyCfg.py ${RUN_DIR}/cfg_RunIII2024Summer24DRPremix.py ${RUN_DIR}/out_DRPremix_step.py --randomSeeds=${SEED} --strategy 1
